...
contextBridge.exposeInMainWorld('photoMemoryAdmin', {
  ...
  defaultDailyRoot: (mode) => ipcRenderer.invoke('daily:default-root', mode),
  scanDailyFolder: (rootPath, mode) => ipcRenderer.invoke('daily:scan', rootPath, mode),
  pickDailyRoot: (mode) => ipcRenderer.invoke('daily:pick-root', mode),
  ...
  saveLineItUpChallengeData: (payload) => ipcRenderer.invoke('line-it-up:save-challenge-data', payload),
